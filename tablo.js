...
(function(){
  ...
  s.textContent='#list{display:block!important;grid-template-columns:none!important}.sheetTab{width:100%;border-collapse:collapse;font-size:13px;background:#fff}.sheetTab th{background:#e85d04;color:#fff;padding:7px 6px;text-align:left;position:sticky;top:0}.sheetTab td{border:1px solid #f0c9a8;padding:4px 6px}.sheetTab tr:nth-child(even) td{background:#fff4ea}.sheetTab td.ad{white-space:nowrap;font-weight:600}.sheetTab input{width:58px;padding:3px;border:1px solid #e0c4a8;border-radius:6px}';
